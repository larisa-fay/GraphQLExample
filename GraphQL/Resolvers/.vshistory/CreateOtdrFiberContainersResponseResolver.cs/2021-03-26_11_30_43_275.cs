...
namespace AFL.OTDR.Service.GraphQL.InternalOTDR
{
	public class CreateOtdrFiberContainersResponseResolver
    {
            ...
            [Service] IMapper mapper)
        {
            ...
            List<OtdrFiberContainerResponseType> tempResList =
                new List<OtdrFiberContainerResponseType>();
            OtdrFiberContainerResponseType tempresult = new OtdrFiberContainerResponseType
            {
        ...
        public CreateOtdrFiberContainersErrorType GetTempCopyFiberResponseError([Service] SorEntryService fileService,
            [Service] IMapper mapper)
        {
            List<SorEntry> sample = fileService.EntriesSample(3);
